...
export default function TiltFlipCard({
  ...
  return (
    <>
      ...
      <div
        ref={sceneRef}
        className={`${styles.scene} ${entranceClass}${isExpanded ? ` ${styles.isExpanded}` : ""}${isReturning ? ` ${styles.isReturning}` : ""}`}
        style={cssVars}
      ...
      >
        <div
          ref={tiltRef}
          className={`${styles.tilt}${isExpanded ? ` ${styles.isExpanded}` : ""}${isReturning ? ` ${styles.isReturning}` : ""}`}
          onDragStart={(e) => e.preventDefault()}
        >
          <div className={`${styles.flip}${isFlipped ? ` ${styles.isFlipped}` : ""}`}>
            <div className={`${styles.face} ${styles.front}${frontImg && !isFrontImageVisible ? ` ${styles.hasLoadingImage}` : ""}`}>
              {frontImg && (
                <picture>
                  {frontWebpSrcSet && (
                    <source
                  ...
                  <img
                    src={frontImg}
                    alt=""
                    className={`${styles.bgImage} ${isFrontImageVisible ? styles.isLoaded : styles.isLoading}`}
            ...
            <div className={`${styles.face} ${styles.back}${isExpanded ? ` ${styles.backExpanded}` : ""}${backImg && !isBackImageVisible ? ` ${styles.hasLoadingImage}` : ""}`}>
              {backImg && (
                <img
                  src={backImg}
                  alt=""
                  className={`${styles.bgImage} ${isBackImageVisible ? styles.isLoaded : styles.isLoading}`}
                  loading="lazy"
                  decoding="async"
                  draggable="false"
                />
